...
live2d_settings['aboutPageUrl'] = 'https://zykjofficial.gitee.io/about';   // 关于页地址, '{URL 网址}'
...
function loadModel(modelId, modelTexturesId = 0) {
    ...
    loadlive2d('live2d', live2d_settings.modelAPI + 'get/?id=' + modelId + '-' + modelTexturesId, (live2d_settings.showF12Status ? console.log('[Status]', 'live2d', '模型', modelId + '-' + modelTexturesId, '加载完成ヾ(•ω•`)o') : null));
}
